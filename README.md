...
Il faut d'abord démarrer MariaDB et s'assurer qu'elle a bien démarré :
<pre>
...
- [**Dockerfile**](https://raw.githubusercontent.com/bbouchra28/Dockerisation-de-PrimeKey-SignServer/master/Dockerisation/Dockerfile)             : Ce fichier permet à docker de construire l'image en lisant les instructions écrite dans ce fichier.
- [**signserver_install.sh**](https://raw.githubusercontent.com/bbouchra28/Dockerisation-de-PrimeKey-SignServer/master/Dockerisation/signserver_install.sh)  : Le script d'installation automatique utilisé dans la partie principale.
- [**init.sh**](https://raw.githubusercontent.com/bbouchra28/Dockerisation-de-PrimeKey-SignServer/master/Dockerisation/init.sh)                : Ce script permet d'initialiser les conteneurs utilisant l'image SignServer.
